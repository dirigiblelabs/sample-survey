...
.factory('$messageHub', [function(){
	...
	var message = function(evtName, data){
		messageHub.post({data: data}, 'survey-admin.Survey.Campaigns.' + evtName);
	};
	...
	return {
		...
		onEntityRefresh: function(callback) {
			on('survey-admin.Survey.Campaigns.refresh', callback);
		},
...
.controller('PageController', function ($scope, $http, $messageHub) {
	...
	var api = '../../../../../../../../services/v4/js/survey-admin/api/Survey/Campaigns.js';
