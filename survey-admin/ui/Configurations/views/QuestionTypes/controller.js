...
.factory('$messageHub', [function(){
	...
	var message = function(evtName, data){
		messageHub.post({data: data}, 'survey-admin.Configurations.QuestionTypes.' + evtName);
	};
	...
	return {
		...
		onEntityRefresh: function(callback) {
			on('survey-admin.Configurations.QuestionTypes.refresh', callback);
		},
...
.controller('PageController', function ($scope, $http, $messageHub) {
	...
	var api = '../../../../../../../../services/v4/js/survey-admin/api/Configurations/QuestionTypes.js';
