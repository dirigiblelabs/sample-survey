...
var dao = require("survey-admin/data/dao/Survey/QuestionOptions");
...
rs.service()
	...
	.resource("{id}")
		.get(function(ctx) {
			...
			if (entity) {
				...
				http.sendResponseNotFound("QuestionOptions not found");
			}
		})
		.catch(function(ctx, error) {
            if (error.name === "ForbiddenError") {
	...
	.resource("")
		.post(function(ctx, request, response) {
			...
			response.setHeader("Content-Location", "/services/v4/js/survey-admin/api/QuestionOptions.js/" + entity.Id);
